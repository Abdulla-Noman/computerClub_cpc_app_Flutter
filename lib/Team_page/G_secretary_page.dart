...
class General_SecretaryPage extends StatefulWidget {
  const General_SecretaryPage({Key? key}) : super(key: key);

  @override
  _General_SecretaryPageState createState() => _General_SecretaryPageState();
}

class _General_SecretaryPageState extends State<General_SecretaryPage> {
  @override
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Text('Meet The General Secretary',style: TextStyle(fontSize: 22.0),),
          ),
          Expanded(
            child: GridView(
